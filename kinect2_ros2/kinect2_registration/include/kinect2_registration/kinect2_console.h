...
#define OUT_DEBUG(node, msg) RCLCPP_DEBUG_STREAM(node->get_logger(), msg)
#define OUT_INFO(node, msg) RCLCPP_INFO_STREAM(node->get_logger(), msg)
#define OUT_WARN(node, msg) RCLCPP_WARN_STREAM(node->get_logger(), msg)
#define OUT_ERROR(node, msg) RCLCPP_WARN_STREAM(node->get_logger(), msg)
